...
// CHistoryStates wrapper class

class CHistoryStates : public COleDispatchDriver
{
public:
    CHistoryStates(){} // Calls COleDispatchDriver default constructor
    CHistoryStates(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
    CHistoryStates(const CHistoryStates& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

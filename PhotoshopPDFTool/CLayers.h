...
// CLayers wrapper class

class CLayers : public COleDispatchDriver
{
public:
    CLayers(){} // Calls COleDispatchDriver default constructor
    CLayers(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
    CLayers(const CLayers& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

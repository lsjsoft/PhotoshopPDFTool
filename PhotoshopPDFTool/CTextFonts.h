...
// CTextFonts wrapper class

class CTextFonts : public COleDispatchDriver
{
public:
    CTextFonts(){} // Calls COleDispatchDriver default constructor
    CTextFonts(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
    CTextFonts(const CTextFonts& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

...
// CLayerSets wrapper class

class CLayerSets : public COleDispatchDriver
{
public:
    CLayerSets(){} // Calls COleDispatchDriver default constructor
    CLayerSets(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
    CLayerSets(const CLayerSets& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
    ...
    {
        LPDISPATCH result;
        InvokeHelper(0x634c5a6a, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, NULL);
        return result;
    }

    // LayerSets properties
public:

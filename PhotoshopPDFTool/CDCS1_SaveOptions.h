...
// CDCS1_SaveOptions wrapper class

class CDCS1_SaveOptions : public COleDispatchDriver
{
public:
    CDCS1_SaveOptions(){} // Calls COleDispatchDriver default constructor
    CDCS1_SaveOptions(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
    CDCS1_SaveOptions(const CDCS1_SaveOptions& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

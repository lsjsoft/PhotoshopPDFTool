...
// CPathPoints wrapper class

class CPathPoints : public COleDispatchDriver
{
public:
    CPathPoints(){} // Calls COleDispatchDriver default constructor
    CPathPoints(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
    CPathPoints(const CPathPoints& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

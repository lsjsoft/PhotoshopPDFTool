...
// CEPSOpenOptions wrapper class

class CEPSOpenOptions : public COleDispatchDriver
{
public:
    CEPSOpenOptions(){} // Calls COleDispatchDriver default constructor
    CEPSOpenOptions(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
    CEPSOpenOptions(const CEPSOpenOptions& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
